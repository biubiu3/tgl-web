...
<link rel="icon" href="{asset}favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="{asset}style.css?v=agent3"><script src="{asset}app.js?v=agent3" defer></script>
