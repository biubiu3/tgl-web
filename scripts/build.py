...
<meta property="og:type" content="article"><meta property="og:title" content="Teach and Grow"><meta property="og:description" content="{description}"><meta property="og:url" content="{page_url}"><meta property="og:image" content="{url}assets/brand/tgl-cover-v3.png"><meta name="twitter:card" content="summary_large_image">
...
<figure class="project-cover container"><a class="zoom" href="{asset}brand/tgl-cover-v3.png" aria-label="{t('Enlarge project cover','放大项目封面')}"><img src="{asset}brand/tgl-cover-v3.png" width="1672" height="941" alt="{t('Conceptual cover: a robot adapts a bowl-placement skill to a changed tabletop; a few demonstrations and agent guidance contrast with VLA/WAM data and training costs','概念封面：机器人将放碗技能适应到变化的桌面；少量示教与智能体指导，对照 VLA/WAM 的数据和训练成本')}" fetchpriority="high"><span class="zoom-label">↗ {t('Enlarge','放大')}</span></a><figcaption>{t('New scenes, reusable skills: sparse teaching and agent-guided execution with fixed model weights. Conceptual artwork.','场景变化，技能复用：通过少量示教与智能体指导，在模型权重固定的条件下适应任务。概念封面。')}</figcaption></figure>
{narrative['overview']}
{narrative['origins']}
{narrative['idea']}
{narrative['method']}
