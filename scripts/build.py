...
<meta property="og:type" content="article"><meta property="og:title" content="Teach and Grow"><meta property="og:description" content="{description}"><meta property="og:url" content="{page_url}"><meta property="og:image" content="{url}assets/brand/tgl-cover.png"><meta name="twitter:card" content="summary_large_image">
...
<figure class="project-cover container"><img src="{asset}brand/tgl-cover.png" width="1672" height="941" alt="{t('Teach and Grow conceptual cover: teaching examples, agent reasoning, reusable skills, and robotic manipulation','Teach and Grow 概念封面：示教、智能体推理、可复用技能与机器人操作')}" fetchpriority="high"><figcaption>{t('Teach and Grow · From sparse teaching to reusable robot capability. Conceptual artwork.','Teach and Grow · 从少量示教到可复用的机器人能力。概念视觉。')}</figcaption></figure>
{narrative['overview']}
{narrative['origins']}
{narrative['idea']}
{narrative['method']}
