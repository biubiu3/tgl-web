...
<meta property="og:type" content="article"><meta property="og:title" content="Teach and Grow"><meta property="og:description" content="{description}"><meta property="og:url" content="{page_url}"><meta property="og:image" content="{url}assets/brand/tgl-cover-v2.png"><meta name="twitter:card" content="summary_large_image">
...
<figure class="project-cover container"><a class="zoom" href="{asset}brand/tgl-cover-v2.png" aria-label="{t('Enlarge research overview','放大研究总览')}"><img src="{asset}brand/tgl-cover-v2.png" width="1672" height="941" alt="{t('Research overview: VLA/WAM adaptation costs; TGL uses few demonstrations, an LLM-powered AI agent, reusable Skill Blocks, execution feedback, a Skill Library, and Experience Memory','研究总览：VLA/WAM 的适应成本；TGL 通过少量示教、LLM 驱动的 AI Agent、Skill Block、执行反馈、技能库与经验记忆积累能力')}" fetchpriority="high"><span class="zoom-label">↗ {t('Enlarge','放大')}</span></a><figcaption>{t('From the VLA/WAM adaptation bottleneck to agent-centered skill acquisition. Conceptual method overview; ChatGPT, Codex, and Claude illustrate the broader agent ecosystem, not a multi-model evaluation.','从 VLA/WAM 的任务适应瓶颈，到 AI Agent 驱动的技能获取。此图为方法概念图；ChatGPT、Codex 和 Claude 表示相关智能体生态，并非多模型评测。')}</figcaption></figure>
{narrative['overview']}
{narrative['origins']}
{narrative['idea']}
{narrative['method']}
...
</main><footer class="container"><a class="brand" href="#">TGL<span class="brand-dot">.</span></a><p>Teach and Grow · Shanghai Jiao Tong University<br><span>{t('Self-hosted images and videos. No analytics or third-party embeds.','图片与视频均由本站提供，无统计追踪或第三方嵌入。')}</span></p><a href="#">{t('Back to top','返回顶部')} ↑</a></footer><dialog id="image-dialog" aria-label="{t('Enlarged research image','放大的研究图片')}"><button class="dialog-close" aria-label="{t('Close image','关闭图片')}">×</button><img alt=""><p></p></dialog>
</body></html>'''
