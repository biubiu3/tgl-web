...
- `scripts/build.py`: bilingual page content, figures, metadata, and BibTeX.
- `assets/style.css`: responsive layout and styling.
- `assets/app.js`: paired playback, filters, benchmark tabs, citation copy, figure lightbox.
